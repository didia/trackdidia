...
| Type | Accept applies |
|---|---|
| `review_section_draft` | Persists the ritual note on the weekly review (Dimanche notes go on the following week when the displayed week is past), then marks the proposal accepted |

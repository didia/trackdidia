...
|---|---|---|---|
| 2026-09-08 | Documented the nine email triage tables and indexes; vault commands exist but this slice does not persist secrets; a failed evaluation disables automation and a passing run leaves it unchanged | `docs/storage-and-backups.md`, `docs/email-triage.md` | Migration 29 indexes, `saveEvaluation`, `src-tauri/src/vault.rs` |

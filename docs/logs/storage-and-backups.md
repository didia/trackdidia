...
|---|---|---|---|
| 2026-09-08 | Migration 29 adds email triage tables and `gtd_tasks.source_url`; OS vault commands store triage/provider secrets outside SQLite | `docs/storage-and-backups.md`, `docs/email-triage.md` | Migration `add_email_triage_foundation`, `src-tauri/src/vault.rs` |
